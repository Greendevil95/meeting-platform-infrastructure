...
TOPICS=(
  ...
  "meeting-service.dlt.user-created"
  "meeting-service.dlt.user-updated"
  "meeting-service.dlt.user-deleted"
  "meeting-service.dlt.user-status-changed"
  "notification-service.dlt.user-created"
  "notification-service.dlt.user-updated"
  "notification-service.dlt.user-deleted"
  "notification-service.dlt.user-status-changed"
  "notification-service.dlt.meeting-created"
  "notification-service.dlt.meeting-updated"
  "notification-service.dlt.meeting-cancelled"
  "notification-service.dlt.meeting-participant-added"
  "notification-service.dlt.meeting-participant-removed"
)
